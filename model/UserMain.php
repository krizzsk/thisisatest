  ...
  public function drawSpecificItem($item){
    ...
    if ($item=='buttonSendMail') {
      ...
      if (!$this->isContact or !$canReadContact or ! $this->id) {
        ...
        $result .= '<div style="position:absolute; left:215px;top:390px" title="' . i18n('goToContact') . '" onclick="gotoElement(\'Contact\',\''.htmlEncode($this->id).'\');">';
      ...
      if (!$this->isResource or !$canReadResource or ! $this->id) {
        ...
        $result .= '<div style="position:absolute; left:215px;top:426px" title="' . i18n('goToResource') . '" onclick="gotoElement(\'Resource\',\''.htmlEncode($this->id).'\');">';
        $result .= formatSmallButton("Goto", true);
        $result .= '</div>';
        return $result;
      }
