    ...
    $result="";
     ...
     if ($item=='isContactGoTo') {
       ...
       if (!$this->isContact or !$canReadContact or ! $this->id) {
         ...
         $result .= '<div style="position:absolute; left:215px;top:538px" title="' . i18n('goToContact') . '" onclick="gotoElement(\'Contact\',\''.htmlEncode($this->id).'\');">';
       ...
       if (!$this->isUser or !$canReadUser or ! $this->id) {
         ...
         $result .= '<div style="position:absolute; left:215px;top:575px" title="' . i18n('goToUser') . '" onclick="gotoElement(\'User\',\''.htmlEncode($this->id).'\');">';
         $result .= formatSmallButton("Goto", true);
         $result .= '</div>';
         return $result;
       }
      ...
      if (!$this->isResource or !$canReadResource or ! $this->id) {
        ...
        $result .= '<div style="position:absolute; left:215px;top:612px" title="' . i18n('goToResource') . '" onclick="gotoElement(\'Resource\',\''.htmlEncode($this->id).'\');">';
        $result .= formatSmallButton("Goto", true);
        $result .= '</div>';
        return $result;
      }
