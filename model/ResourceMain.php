  ...
  public function drawSpecificItem($item){
    ...
    //gautier #resourceTeam
      ...
      if (! $this->isContact or !$canReadContact or ! $this->id) {
        ...
        $result .= '<div style="position:absolute; left:215px;top:685px" title="' . i18n('goToContact') . '" onclick="gotoElement(\'Contact\',\''.htmlEncode($this->id).'\');">';
      ...
      if (!$this->isUser or !$canReadUser or ! $this->id) {
        ...
        $result .= '<div style="position:absolute; left:215px;top:723px" title="' . i18n('goToUser') . '" onclick="gotoElement(\'User\',\''.htmlEncode($this->id).'\');">';
        $result .= formatSmallButton("Goto", true);
        $result .= '</div>';
        return $result;
      }
      ...
      if (!$this->isEmployee or !$canReadEmployee or ! $this->id) {
        ...
        $result .= '<div style="position:absolute; left:215px;top:760px" title="' . i18n('goToEmployee') . '" onclick="gotoElement(\'Employee\',\''.htmlEncode($this->id).'\');">';
        $result .= formatSmallButton("Goto", true);
        $result .= '</div>';
        return $result;
      }
