  ...
  public function drawSpecificItem($item){
    ...
    if ($item=='affectations') {
      ...
      if (!$this->isUser or !$canReadUser or ! $this->id) {
        ...
        $result .= '<div style="position:absolute; left:215px;top:501px" title="' . i18n('goToUser') . '" onclick="gotoElement(\'User\',\''.htmlEncode($this->id).'\');">';
      ...
      if (!$this->isResource or !$canReadResource or ! $this->id) {
        ...
        $result .= '<div style="position:absolute; left:215px;top:537px" title="' . i18n('goToResource') . '" onclick="gotoElement(\'Resource\',\''.htmlEncode($this->id).'\');">';
        $result .= formatSmallButton("Goto", true);
        $result .= '</div>';
        return $result;
      }
