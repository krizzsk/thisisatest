 ...
 */
    ...
    $showSelectedProject=null;
    if(RequestHandler::isCodeSet('showSelectedProject') and RequestHandler::getId('showSelectedProject') != ''){
      $showSelectedProject = pq_trim(RequestHandler::getId('showSelectedProject'));
    }
...
// MTY - LEAVE SYSTEM
        if ( ((getSessionValue('project')!='*' and !$showAllProjects) or getSessionValue('idFavoriteProjectList')) and $showSelectedProject == null) {
          $queryWhere.= ($queryWhere=='')?'':' and ';
          ...
          $queryWhere.= ($queryWhere=='')?'':' and ';
          $queryWhere.=  "($table.idProject in ".getVisibleProjectsList(! $showIdleProjects, $showSelectedProject).")";
        }
    }
